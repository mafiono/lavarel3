 ...
 * Generated for Laravel 5.1.45 (LTS) on 2017-01-20.
 *
...
namespace {
    ...
    class SportsBonus extends \App\Bonus\SportsBonusFacade{
         ...
         * @static 
         */
        public static function make($user = null, $bonus = null){
            return \App\Bonus\BaseSportsBonus::make($user, $bonus);
        }
        ...
        public static function getAvailable($columns = array()){
            return \App\Bonus\BaseSportsBonus::getAvailable($columns);
        }
        ...
        public static function getActive($columns = array()){
            return \App\Bonus\BaseSportsBonus::getActive($columns);
        }
        ...
        public static function getConsumed($columns = array()){
            return \App\Bonus\BaseSportsBonus::getConsumed($columns);
        }
        ...
        public static function hasActive(){
            return \App\Bonus\BaseSportsBonus::hasActive();
        }
        ...
        public static function isAvailable($bonusId){
            return \App\Bonus\BaseSportsBonus::isAvailable($bonusId);
        }
        ...
        public static function redeem($bonusId){
            return \App\Bonus\BaseSportsBonus::redeem($bonusId);
        }
        ...
        public static function deposit(){
            return \App\Bonus\BaseSportsBonus::deposit();
        }
        ...
        public static function cancel(){
            return \App\Bonus\BaseSportsBonus::cancel();
        }
        ...
        public static function forceCancel(){
            return \App\Bonus\BaseSportsBonus::forceCancel();
        }
        ...
        public static function isCancellable(){
            return \App\Bonus\BaseSportsBonus::isCancellable();
        }
        ...
        public static function isAutoCancellable(){
            return \App\Bonus\BaseSportsBonus::isAutoCancellable();
        }
        ...
        public static function isPayable(){
            return \App\Bonus\BaseSportsBonus::isPayable();
        }
        ...
        public static function addWagered($amount){
            return \App\Bonus\BaseSportsBonus::addWagered($amount);
        }
        ...
        public static function subtractWagered($amount){
            return \App\Bonus\BaseSportsBonus::subtractWagered($amount);
        }
         ...
         * @static 
         */
        public static function applicableTo($bet){
            return \App\Bonus\BaseSportsBonus::applicableTo($bet);
        }
         ...
         * @static 
         */
        public static function depositNotify($trans){
            return \App\Bonus\BaseSportsBonus::depositNotify($trans);
        }
        ...
        public static function pay(){
            return \App\Bonus\BaseSportsBonus::pay();
        }
        ...
        public static function hasId($bonusId){
            return \App\Bonus\BaseSportsBonus::hasId($bonusId);
        }
        ...
        public static function userBonus(){
            return \App\Bonus\BaseSportsBonus::userBonus();
        }
