...
<!--    Os nossos serviços de localização detectaram que se encontra em --><?php //echo $_GET['p'] ?><!--.<br><br>-->
    ...
    Lamentamos a inconveniência causada.<br><br>

    Número Gratuito<br>
    0000000000<br><br>

    Alternativamente, por favor ligue para:<br>
    000000000<br>
...
<!--    Our location services have detected you are in --><?php //echo $_GET['p'] ?><!--.<br><br>-->
    ...
    We apologise for any inconvenience this has caused.<br><br>

    Freephone<br>
    000000000000<br><br>

    Alternatively, please call us on:<br>
    000000000000<br>
