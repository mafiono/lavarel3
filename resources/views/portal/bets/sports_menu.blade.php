<div class="sportsMenu-container">
    ...
    <div class="sportsMenu-box menu popular">
        <span class="sportsMenu-text"><i class="fa fa-star" aria-hidden="true"></i> &nbsp;&nbsp;Populares</span>
        <span class="sportsMenu-text popular caret">&nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i></span>
    </div>
