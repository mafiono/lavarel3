<div class="col-xs-12 footer neut-back neut-color">
	<div class="main">
    	<div class="social">
        ...
        <div class="footer-menu">
        	<ul>
            	<a href="/sobre_nos"><li class="brand-trans">Sobre Nós</li></a>
            	<a href="/afiliados"><li class="brand-trans footer-menu-option">Afiliados</li></a>
            	<a href="/termos_e_condicoes"><li class="brand-trans footer-menu-option">Termos e Condições</li></a>
            	<a href="/contactos"><li class="brand-trans footer-menu-option">Contactos</li></a>
            	<a href="/ajuda"><li>Ajuda</li></a>
            	<a href="/promocoes"><li class="brand-trans footer-menu-option">Promoções</li></a>
            	<a href="/faq"><li class="brand-trans footer-menu-option">FAQ</li></a>
            	<a href="/territorios_restritos"><li class="brand-trans footer-menu-option">Territórios Restritos</li></a>
                <div class="clear"></div>
            </ul>
