Handlebars.registerPartial('statistics', '\
    <div class="statistics">\
        ...
        <p>A informação estatística disponibilizada no site deve ser usada somente como uma guia. A Bet Portugal não se responsabiliza por eventuais erros nos dados estatísticos fornecidos pela score24. </p>\
    </div>\
');
