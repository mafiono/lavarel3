Handlebars.registerPartial('statistics', '\
    <div class="statistics">\
        <div class="header">{{name}}&nbsp;\
            ...
            <i id="statistics-open" class="cp-stats-dots"></i>\
        </div>\
        <iframe src="https://www.score24.com/statistics3/index.jsp?partner=casinoportugal&gameId={{id}}" style="width: 100%" height="1800" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>\
