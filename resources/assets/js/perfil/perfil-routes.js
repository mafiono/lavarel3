module.exports = {
    perfil: {
        ...
        sub: {
            ...
            autenticacao: {key: 'autenticacao', name: 'Autenticação', link: '/autenticacao', events: require('./helpers/input-file')},
    ...
    banco: {
        ...
        sub: {
            ...
            depositar: {key: 'depositar', name: 'Depositar', link: '/banco/depositar'},
