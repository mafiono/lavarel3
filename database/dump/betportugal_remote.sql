...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `betportugal` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `bonus` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `bonus_type_id` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `title` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `value` decimal(15,2) NOT NULL,
  `value_type` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `apply` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `apply_deposit_methods` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `destiny` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `destiny_operation` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `destiny_value` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `focus` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `bonus_segment_id` int(11) NOT NULL,
  `target` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `user_documentation` (
  ...
  `user_session_id` int(10) unsigned NOT NULL,
  `staff_session_id` int(10) unsigned DEFAULT NULL,
  `status_id` varchar(45) COLLATE utf8_unicode_ci DEFAULT 'pending',
...
CREATE TABLE `user_profiles` (
  ...
  `professional_situation` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_self_exclusions` (
  ...
  `motive` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_sessions` (
  ...
  `session_number` int(11) NOT NULL,
  `session_id` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `session_type` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_statuses` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `staff_session_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
