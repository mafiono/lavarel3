...
class SimpleCaptcha
{
    ...
    public function generateCaptcha($config = array())
    {
        ...
        $image_src = $this->path . '?_CAPTCHA&amp;t=' . urlencode(microtime());
        $image_src = '/' . ltrim(preg_replace('/\\\\/', '/', $image_src), '/');

        return array(
            'session' => $captcha_config,
    ...
    // Draw the image
    public function drawImg($captcha_config) {
